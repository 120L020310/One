...
from controlled_ex.Davit.lit_model import Davit_lit
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_dir",type=str,default="/home/zyz/data/transfered_data/LibriSeVoc/MLAAD_cross_lang")
