...
def get_args():
    ...
    parser.add_argument(
        "-m_filts", type=list, default=[128, [128, 128], [128, 256], [256, 256]]
    )
    ...
    parser.add_argument(
        "-make_val_trial", type=str2bool, nargs="?", const=True, default=False
    )
    parser.add_argument("-debug", type=str2bool, nargs="?", const=True, default=False)
    parser.add_argument(
        "-comet_disable", type=str2bool, nargs="?", const=True, default=False
    )
    parser.add_argument(
        "-save_best_only", type=str2bool, nargs="?", const=True, default=False
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-load_model", type=str2bool, nargs="?", const=True, default=False
    )
    parser.add_argument(
        "-reproducible", type=str2bool, nargs="?", const=True, default=True
    )
