...
class RawNet2(nn.Module):
    def __init__(self, d_args):
        ...
        # used for classfication of vocoders
        self.fc3_gru = nn.Linear(in_features = d_args['nb_fc_node'],
            out_features = 14,
            bias = True)
    ...
    def forward(self, x, y = 0, is_test=False):
        ...
        out2 = self.fc3_gru(code)
        
        return out, out2


    def extract_feature(self, x, y = 0, is_test=False):
        '''
            the default shape of x is (N, L), not (N, C, L) since C = 1.
