...
class CustomNameExperimentWriter(ExperimentWriter):
    ...
    def __init__(self, log_dir: str, csv_name=None) -> None:
        ...
        self.metrics_file_path = os.path.join(
            self.log_dir, csv_name or "metrics.csv"
...
class CustomNameCSVLogger(CSVLogger):
    ...
    def __init__(self, *args, csv_name=None, **kwargs):
    ...
    def experiment(self) -> CustomNameExperimentWriter:
        ...
        self._experiment = CustomNameExperimentWriter(
            log_dir=self.log_dir, csv_name=self._csv_name
        )
        return self._experiment
