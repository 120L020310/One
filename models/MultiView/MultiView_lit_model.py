...
from myutils.torch.losses.Contrast_loss import BinaryTokenContrastLoss, CLIPLoss1D
from myutils.torch.losses import LabelSmoothingBCE
...
class MultiViewModel_lit(DeepfakeAudioClassification):
    ...
    def _shared_pred(self, batch, batch_idx, stage="train"):
        ...
        return batch_res
    def forward(self, audio, stage="train"):
        """common predict step for train/val/test
