...
if __name__ == "__main__":
    ...
    if not args.test:
        ...
        ckpt_path = "/home/zyz/data/dim=128_test/1227_XLSR_oneclass_post_std/MultiView/ASV2021_inner/version_0/checkpoints/epoch=6-val-auc=0.9664-val-eer=0.0853.ckpt"
        trainer.trainset_wo_transform = dl.train_wo_transform
