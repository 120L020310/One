...
from models.MultiView.esresnet import attention
from models.MultiView.esresnet.transforms import scale
...
class _ESResNet(ResNetWithAttention):
    ...
    def split_spectrogram(self, spec: torch.Tensor, batch_size: int) -> torch.Tensor:
        ...
        spec = spec.reshape(
            batch_size, -1, spec.shape[-3] // self.conv1.in_channels, *spec.shape[-2:]
        )
