...
from igsvd.lit_model import IG_SVD_lit
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_dir",type=str,default="/home/zyz/data/transfered_data/igsvd")
    ...
    trainer = pl.Trainer(
        max_epochs=-1 if args.use_profiler else cfg.MODEL.epochs,
        accelerator="gpu",
        devices=args.gpu,
        logger=logger,
