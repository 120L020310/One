...
class AudioFakeDetector(AbstractDetector):
    ...
    def __init__(self, config, vocoder_num_class=20):
        super().__init__()
        self.config = config
        ...
        # head
        specific_task_number = vocoder_num_class # 7 for LibriSeVoc
        self.head_spe = Head(
    ...
    def get_losses(self, data_dict: dict, pred_dict: dict, inference=False) -> dict:
        # print(f'In get_losses, inference: {inference}')
    ...
    def get_train_losses(self, data_dict: dict, pred_dict: dict) -> dict:
        # print('In get_train_losses', data_dict.keys(), pred_dict.keys())
        # print(data_dict)
        ...
        # print(pred_spe.shape, label_spe.shape, label_spe)
        ...
        # print(f'common_features: {common_features.shape}, specific_features: {specific_features.shape}', "label", label_spe.shape,  data_dict.keys())
        # print(f'common_features: {common_features.shape}, specific_features: {specific_features.shape}', "label", label_spe.shape,  data_dict.keys())
        # print(label_spe)
    ...
    def forward(self, data_dict: dict, inference=False) -> dict:
        ...
        # reconstruction loss
        f2, f1 = f_all,f_all # the f1 or f2 its dim1 contain the specific-forgery and common-forgery features!
        c2, c1 = content_features,content_features
