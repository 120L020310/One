...
# +
# modified from https://github.com/Docta-ai/docta/blob/1a58eac22746eceab7736d936fb7f4740d2e9fcf/docta/models/backbones/resnet.py
...
# +
model = MvitVideoEncoder(v_cla_feature_in=256, temporal_size=512)

x = torch.rand(2, 3, 512, 96, 96)
model(x).shape
# -
