...
def extract_bank(model, train_loader, device, memory_bank_path):
    ...
    np.savez(memory_bank_path, feats=memory_bank, dtype=np.float32)
    return memory_bank
...
if __name__ == "__main__":   
    ...
    parser.add_argument("-ckpt", "--checkpoint", type=str, 
                        default="/home/zyz/data/dim=128_test/data_aug_SafeRawAugmentor(noise_intensity=0.1, mask_ratio=0.1)_5:1/1227_baseline_detach_noisy/MultiView/ASV2021_LA/version_0/checkpoints/epoch=7-val-auc=0.9602-val-eer=0.0890_no_post_std.ckpt")
    ...
    memory_bank_path = "memory_bank_xlsr_best_0890.pt"
