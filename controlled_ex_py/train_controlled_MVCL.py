...
from models.MultiView.MultiView_lit_model import MultiViewModel_lit
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_dir",type=str,default="/home/zyz/data/test_model_save/best_MVCL")
