...
from controlled_ex.MPE_LCNN.lit_model import MPE_LCNN_lit
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_dir",type=str,default="/home/zyz/data/transfered_data/MPE_LCNN/ASV2021_LA")
